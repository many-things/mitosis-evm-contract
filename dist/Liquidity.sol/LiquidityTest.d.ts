...
export interface LiquidityTestInterface extends Interface {
    getFunction(nameOrSignature: "IS_TEST" | "excludeArtifacts" | "excludeContracts" | "excludeSenders" | "failed" | "generateAccessControlMessage" | "setUp" | "targetArtifactSelectors" | "targetArtifacts" | "targetContracts" | "targetSelectors" | "targetSenders" | "test_deposit_erc20" | "test_deposit_erc2612" | "test_withdraw_erc20" | "test_withdraw_underflow"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "generateAccessControlMessage", values: [AddressLike, BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: "test_deposit_erc20", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_deposit_erc2612", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_withdraw_erc20", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_withdraw_underflow", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "generateAccessControlMessage", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "test_deposit_erc20", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_deposit_erc2612", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_withdraw_erc20", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_withdraw_underflow", data: BytesLike): Result;
}
...
export interface LiquidityTest extends BaseContract {
    connect(runner?: ContractRunner | null): BaseContract;
    attach(addressOrName: AddressLike): this;
    deployed(): Promise<this>;
    interface: LiquidityTestInterface;
    ...
    generateAccessControlMessage: TypedContractMethod<[
        addr: AddressLike,
        role: BytesLike
    ], [
        string
    ...
    test_deposit_erc20: TypedContractMethod<[], [void], "nonpayable">;
    test_deposit_erc2612: TypedContractMethod<[], [void], "nonpayable">;
    test_withdraw_erc20: TypedContractMethod<[], [void], "nonpayable">;
    test_withdraw_underflow: TypedContractMethod<[], [void], "nonpayable">;
    ...
    getFunction(nameOrSignature: "generateAccessControlMessage"): TypedContractMethod<[
        addr: AddressLike,
        role: BytesLike
    ], [
        string
    ...
    getFunction(nameOrSignature: "test_deposit_erc20"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "test_deposit_erc2612"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "test_withdraw_erc20"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "test_withdraw_underflow"): TypedContractMethod<[], [void], "nonpayable">;
