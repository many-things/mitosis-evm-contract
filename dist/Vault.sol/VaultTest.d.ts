...
export interface VaultTestInterface extends Interface {
    getFunction(nameOrSignature: "IS_TEST" | "excludeArtifacts" | "excludeContracts" | "excludeSenders" | "failed" | "setUp" | "targetArtifactSelectors" | "targetArtifacts" | "targetContracts" | "targetSelectors" | "targetSenders" | "test_change_owner" | "test_execute" | "test_send_erc20" | "test_send_erc2612"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "InitOperation" | "OwnerChanged" | "log" | "log_address" | "log_array(uint256[])" | "log_array(int256[])" | "log_array(address[])" | "log_bytes" | "log_bytes32" | "log_int" | "log_named_address" | "log_named_array(string,uint256[])" | "log_named_array(string,int256[])" | "log_named_array(string,address[])" | "log_named_bytes" | "log_named_bytes32" | "log_named_decimal_int" | "log_named_decimal_uint" | "log_named_int" | "log_named_string" | "log_named_uint" | "log_string" | "log_uint" | "logs"): EventFragment;
    ...
    encodeFunctionData(functionFragment: "test_change_owner", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_execute", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_send_erc20", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_send_erc2612", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "test_change_owner", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_execute", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_send_erc20", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_send_erc2612", data: BytesLike): Result;
}
...
export declare namespace OwnerChangedEvent {
    type InputTuple = [old: AddressLike, change: AddressLike];
    type OutputTuple = [old: string, change: string];
    interface OutputObject {
        old: string;
        change: string;
    }
...
export interface VaultTest extends BaseContract {
    ...
    test_change_owner: TypedContractMethod<[], [void], "nonpayable">;
    test_execute: TypedContractMethod<[], [void], "nonpayable">;
    test_send_erc20: TypedContractMethod<[], [void], "nonpayable">;
    test_send_erc2612: TypedContractMethod<[], [void], "nonpayable">;
    ...
    getFunction(nameOrSignature: "test_change_owner"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "test_execute"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "test_send_erc20"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "test_send_erc2612"): TypedContractMethod<[], [void], "nonpayable">;
