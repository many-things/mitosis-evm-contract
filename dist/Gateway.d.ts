...
export interface GatewayInterface extends Interface {
    getFunction(nameOrSignature: 'execute' | 'lmgr' | 'owner' | 'send(address,(uint256,bytes[]),(address,uint256))' | 'send(address,(uint256,bytes[]),(address,uint256,uint256,bytes))' | 'send(address,(uint256,bytes[]))' | 'transferOwnership'): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: 'ExecuteOperation' | 'InitOperation' | 'OwnershipTransferred'): EventFragment;
    encodeFunctionData(functionFragment: 'execute', values: [Gateway.ExecutePayloadStruct, BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: 'send(address,(uint256,bytes[]))', values: [AddressLike, OperationStruct]): string;
    ...
    decodeFunctionResult(functionFragment: 'send(address,(uint256,bytes[]))', data: BytesLike): Result;
...
export interface Gateway extends BaseContract {
    ...
    execute: TypedContractMethod<[
        _payload: Gateway.ExecutePayloadStruct,
    ...
    getFunction(nameOrSignature: 'send(address,(uint256,bytes[]))'): TypedContractMethod<[
        _to: AddressLike,
        _op: OperationStruct
    ], [
        void
