...
export interface BondInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: 'bond(uint256,uint256,bytes)',
    values: [
  ...
  encodeFunctionData(
    functionFragment: 'lastClaimedIndex',
    values: [PromiseOrValue<string>],
  ): string
  encodeFunctionData(
    functionFragment: 'lastUnbondingIndex',
    values: [PromiseOrValue<string>],
  ): string
  encodeFunctionData(
