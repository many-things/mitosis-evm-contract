...
export interface VaultTestInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "test_change_owner",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_execute",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_send_erc20",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_send_erc2612",
    values?: undefined
  ): string;
...
export namespace OwnerChangedEvent {
  export type InputTuple = [old: AddressLike, change: AddressLike];
  export type OutputTuple = [old: string, change: string];
  export interface OutputObject {
    old: string;
    change: string;
  }
...
export interface VaultTest extends BaseContract {
  ...
  getFunction(
    nameOrSignature: "test_change_owner"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "test_execute"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "test_send_erc20"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "test_send_erc2612"
  ): TypedContractMethod<[], [void], "nonpayable">;
