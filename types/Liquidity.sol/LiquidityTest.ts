...
export interface LiquidityTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      ...
      | "targetSenders"
      | "test_deposit_erc20"
      | "test_deposit_erc2612"
      | "test_withdraw_erc20"
      | "test_withdraw_underflow"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "generateAccessControlMessage",
  ...
  encodeFunctionData(
    functionFragment: "test_deposit_erc20",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_deposit_erc2612",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_withdraw_erc20",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_withdraw_underflow",
    values?: undefined
  ): string;
...
export interface LiquidityTest extends BaseContract {
  ...
  generateAccessControlMessage: TypedContractMethod<
    [addr: AddressLike, role: BytesLike],
    [string],
    "view"
  >;
  ...
  getFunction(
    nameOrSignature: "generateAccessControlMessage"
  ): TypedContractMethod<
    [addr: AddressLike, role: BytesLike],
    [string],
    "view"
  ...
  getFunction(
    nameOrSignature: "test_deposit_erc20"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "test_deposit_erc2612"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "test_withdraw_erc20"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "test_withdraw_underflow"
  ): TypedContractMethod<[], [void], "nonpayable">;
